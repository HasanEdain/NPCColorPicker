...
open class NPCColorUtility {
    ...
    static func cleanRGBAString(_ rgbaString: String) -> NSString {
        let swiftString = rgbaString.trimmingCharacters(in: .uppercaseLetters)
        var cString:NSString = swiftString as NSString
    ...
    static func cleanHexString(_ hexString: String) -> NSString {
        let characters = NSCharacterSet.whitespacesAndNewlines
        var cString:NSString = hexString.trimmingCharacters(in: characters).uppercased() as NSString
